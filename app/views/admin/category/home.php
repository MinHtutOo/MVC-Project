...
<div class="container-fluid p-0">
    <div class="d-flex" >
        ...
        <?php flash('register_success'); ?>
                ...
                <form action="<?php echo URLROOT . 'category/create'?>" method="post" class="table-border p-5">

                    <div class="form-group">
                        <label for="name" class="form-label">Category Name</label>
                        <input type="text" class="form-control english <?php echo !empty($data['name_err']) ? 'is_invalid' : ''; ?>" id="name" name="name">
